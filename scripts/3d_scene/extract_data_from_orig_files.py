...
# FIXME: this one is VERY LAZY and can be done more effciently!
    ...
    {
        'name' : '__flying_upwards_background_standing_up',
        'type' : 'free',
        'vertices_raw' : [
            ( 40000, 3000, 20000),  # 0: NE
            ( 13000, 3000, 20000),  # 1: NW
            ( 13000, 3000,  9000),  # 2: SW
            ( 40000, 3000,  9000),  # 3: SE
        ],
    },
    {
        'name' : '__flying_upwards_sky',
        'type' : 'free',
        'vertices_raw' : [
            (  -7000,   3000, 20000),  # 0: NE
            (  40000,   3000, 20000),  # 1: NW
            (  40000, -20000, 20000),  # 2: SW
            (  -7000, -20000, 20000),  # 3: SE
        ],
    },
    {
        'name' : '__west_sky',
        'type' : 'free',
        'vertices_raw' : [
            (  -110000, 100000, -1000),  # 0: NE
            (  -110000, 100000, 70000),  # 1: NW
            (  -110000, -90000, 70000),  # 2: SW
            (  -110000, -90000, -1000),  # 3: SE
        ],
    },
    {
        'name' : '__west_logo_floor',
        'type' : 'free',
        'vertices_raw' : [
            (  -30000, 100000, -1000),  # 0: NE
            ( -110000, 100000, -1000),  # 1: NW
            ( -110000, -50000, -1000),  # 2: SW
            (  -30000, -50000, -1000),  # 3: SE
        ],
    },
    ]
